...
def start_scrap(item_choice,base_url,keyword_choice,scroll_times,driver_addr):
    ...
    keywordurl_list = ["/search/?q=IPhone%20x&delivery_param=s_p&radius=50&price_min=100&price_max=",
                       ...
                       "/search/?q=IPhone%205s&delivery_param=s_p&price_min=40&radius=50",
                       ...
                       "/search/?q=google%20pixel%203&delivery_param=s_p&price_min=100&radius=50",
                       "/search/?q=google%20pixel%202&delivery_param=s_p&radius=50&price_min=100"]
